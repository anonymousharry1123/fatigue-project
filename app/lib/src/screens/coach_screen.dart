    ...
    final content = ListView(
      ...
      children: [
        if (embedded) ...[
          ...
          const Text(
            'A plan to beat the predicted crash',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: TonyoColors.mint, fontSize: 10),
                      ),
                    ],
                  ),
                ],
        ...
        const SizedBox(height: 14),
        const Text(
          'Coach actions become interactive in Version 0.18. This Version 0.5.1 screen is a fixture-backed preview.',
